...
;(function () {
    seajs.config({
        ...
        alias: {
            'jquery': '/common/lib/jquery-sea',
            'cookie': '/common/lib/jquery.cookie',
            'bootstrap': '/common/lib/bootstrap.min',
            'datatables': '/common/lib/jquery.dataTables',
            'tabletool': '/common/lib/tabletool',
            'mbox': '/common/lib/mbox',
            'util': '/common/lib/config-util',
            'touch': '/common/lib/touch.min',
            'function': '/common/lib/function',
            'validate': '/common/lib/validate',
            'upload': '/common/lib/jquery.upload',
            'tips': '/common/lib/tips',
            'channels_select':'/common/lib/channels_select',
            'channels_wifi':'/common/lib/channels_wifi',
            'wizard': '/common/lib/jquery.wizard',
            'confirmBox': '/common/lib/jquery.confirmBox',
