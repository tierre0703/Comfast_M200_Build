        ...
        d.each(data, function (n, m) {
            ...
            if (m.childs.length > 0) {
                if (leven == 0) {
                    ...
                    if (this_url.indexOf(m.urls) > -1 || this_url.indexOf(m.urltag) > -1) {
                        ...
                        menu_html += '<a href="' + menu_urls + '" class="dropdown-toggle"><i class="fa ' + m.icon + '"></i>' +
                        '<div><span sh_lang = ' + m.name + '>' + sh_lang + '</span><i class="fa fa-chevron-circle-right drop-icon"></i></div></a>';
                    } else {
                        menu_html += '<li>';
                        menu_html += '<a href="' + menu_urls + '" class="dropdown-toggle"><i class="fa ' + m.icon + '"></i>' +
                           '<div><span sh_lang = ' + m.name + '>' + sh_lang + '</span><i class="fa fa-chevron-circle-right drop-icon"></div></a>';
                    }
            ...
            } else 
            {
                if (leven == 0) {
                    if (this_url.indexOf(m.urls) > -1 || this_url.indexOf(m.urltag) > -1) {
                        menu_html += '<li class="active">';
                    menu_html += '<a href="' + m.urls + '" class="dropdown-toggle"><i class="fa ' + m.icon + '"></i>' +
                        '<div><span sh_lang = ' + m.name + '>' + sh_lang + '</span><i class="fa fa-chevron-circle-right drop-icon"></i></div></a>';
                    } else {
                        menu_html += '<li>';
                        menu_html += '<a href="' + m.urls + '" class="dropdown-toggle"><i class="fa ' + m.icon + '"></i>' +
