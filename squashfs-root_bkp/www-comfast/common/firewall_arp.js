define(function (require, b) {
    ...
    var wan_list, lan_list, vlan_list, arpbind_info, arp_info, this_ifname = {}, optflag;
    ...
    function showtable() {
        ...
        d.each(arpbind_info, function (n, m) {
            ...
            console.dir(this_ifname[m.ifname]);
            this_html += '<td>' + this_ifname[m.ifname] + '</td>';
    ...
    function winit() {
        d('input[type="text"]').val('').removeClass('borError');
