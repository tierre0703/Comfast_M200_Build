...
hwinfo() {
	...
	dev_configs=$(find_mtd_part_arm "configs")
...
get_status_led() {
	...
	cf-ac101 | \
	cf-ac200)
		status_led="comfast:green:system"
		;;
	cf-wr305n)
		status_led="comfast:white:wifi"
		;;		
	cf-wr380ac)
#		status_led="comfast:blue:wps"
		;;
	cf-wr620n)
#		status_led="comfast:blue:wps"
		;;
...
set_wps_state() {
	...
	stop)
		...
		status_led_blink_fast && sleep 5 && status_led_off
		;;
	esac
}
